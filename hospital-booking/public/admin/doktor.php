                                    ...
                                    <table class="table" id="randevuTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Hasta Ad/Soyad</th>
    ...
    <script>
        function DoktorBilgileriGetir() {
            ...
            $.ajax({
                ...
                type: "POST",
                data: { tcno: <?php echo $tcno; ?>, action: "DoktorBilgileriGetir" },
        ...
        function randevuBilgileriGetir() {
            ...
            $.ajax({
                url: "../../system/functions.php",
                type: "POST",
                data: { tcno: <?php echo $tcno; ?>, action: "randevuBilgileriGetirDoktor" },
                success: function (response) {
                    ...
                    for (var i = 0; i < randevular.length; i++) {
                        table.row.add([
                            ...
                            '<a type="button" class="btn btn-primary" href="../admin/hasta.php?tcno=' + randevular[i].tcno + '">Hastayı Görüntüle</a>',
                        ]);
            ...
            Swal.fire({
                ...
                preConfirm: function() {
                    ...
                    $.ajax({
                        url: "../../system/functions.php",
                        type: "POST",
                        data: { tcno: <?php echo $tcno; ?>, ad: ad, soyad: soyad, uzmanlikalani: uzmanlikalani, calistigihastane: calistigihastane, sifre: sifre, action: "doktorBilgileriGuncelle" },
                        success: function (response) {
                            if (response == "success") {
                                Toastify({
