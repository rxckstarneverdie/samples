...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-light">Hastane Sistemi <sub>Hasta</sub> </div>
        ...
        <div id="page-content-wrapper">
            ...
            <!-- Page content-->
            <div class="container-fluid">
                <p class="mt-4 text-muted">• Hastane Yönetim / Hasta / Hasta Profili</p>
    ...
    <script>
        function hastaBilgileriGetir() {
            ...
            $.ajax({
                ...
                type: "POST",
                data: { tcno: <?php echo $_SESSION['tcno']; ?>, action: "hastaBilgileriGetir" },
        ...
        function randevuBilgileriGetir() {
            ...
            $.ajax({
                url: "../../system/functions.php",
                type: "POST",
                data: { tcno: <?php echo $_SESSION['tcno']; ?>, action: "randevuBilgileriGetir" },
                success: function (response) {
            ...
            Swal.fire({
                ...
                preConfirm: function() {
                    ...
                    $.ajax({
                        url: "../../system/functions.php",
                        type: "POST",
                        data: { tcno: <?php echo $_SESSION['tcno']; ?>, ad: ad, soyad: soyad, telno: telno, dogumtarihi: dogumtarihi, adres: adres, cinsiyet: cinsiyet, action: "hastaBilgileriDuzenle" },
                        success: function (response) {
                            if (response == "success") {
                                Toastify({
